  ...
  return (
    ...
    <section className='page-cont'>
      ...
      <article className='article borderer'>
        ...
        So feel free to make searches and save a selection and open in a personal dashboard 'MAKE A LINK OF DASHBOARD BUT PROVIDE PROMPT TO LOGIN OR SIGNUP' with editor to start creating your own book today.</p>
      </article>
    </section>
    </>
  );
